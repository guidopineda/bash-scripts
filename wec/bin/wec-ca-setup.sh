...
echo 'Very_Secure_Password' > pki/ca/private/passphrase.txt
...
openssl req \
	...
	-subj '/C=NL/L=DenHaag/O=Company/OU=LogManagement/CN=LogManagementClientCA' &>/dev/null
...
openssl req \
	...
	-subj '/C=NL/L=DenHaag/O=Company/OU=LogManagement/CN=*' &>/dev/null
